...
def InitialiseModels():
    ...
    OPTIMIZERS = [torch.optim.AdamW(POLICY_NETWORKS[0].parameters(), lr=LEARNING_RATE, amsgrad=True), torch.optim.AdamW(POLICY_NETWORK[1].parameters(), lr=LEARNING_RATE, amsgrad=True)]
...
def OptimizeModel():
    ...
    selected_network = random.randint(0, 2)
